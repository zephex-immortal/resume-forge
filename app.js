...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const orderRes = await fetch('https://resume-forge-blush.vercel.app/api/generate', {
                method: 'POST',
            ...
            const confirmRes = await fetch('https://resume-forge-blush.vercel.app/api/confirm', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...data,
